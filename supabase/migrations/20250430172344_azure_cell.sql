/*
  # Schema update for report improvements

  1. New Columns
    - status: Track report workflow states
    - metadata: Store additional report data
    - search_vector: Enable full-text search

  2. Indexes
    - Added indexes for type, status, created_at, and intervention_id
    - Added GIN index for search_vector

  3. Search
    - Added function and trigger for automatic search vector updates
    - Configured French language support

  4. Security
    - Added function for secure status updates
*/
