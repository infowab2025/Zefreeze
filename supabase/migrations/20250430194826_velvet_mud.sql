/*
  ...
  1. New Indexes
    ...
    - Indexes for company-equipment and intervention-status relationships
  
  2. Functions
    - Equipment status automation based on temperature readings
    - Company equipment summary statistics
    - Intervention and report statistics
