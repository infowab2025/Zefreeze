/*
  # Add Technician Availability System

  1. New Tables
    - technician_availability
      - Stores technician availability data
      - Tracks available dates and time slots
...
-- Add indexes
CREATE INDEX IF NOT EXISTS technician_availability_technician_date_idx 
