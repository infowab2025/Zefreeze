/*
  # Add Installation Request System

  1. New Tables
    - installation_requests
      - Stores client installation requests
...
-- Add RLS policies
CREATE POLICY "Installation requests viewable by company members and technicians" ON installation_requests
  FOR SELECT
  USING (
    company_id IN (
...
CREATE POLICY "Installation requests manageable by admins" ON installation_requests
  FOR ALL
